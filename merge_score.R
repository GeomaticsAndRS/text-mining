...
projects <- read.csv(paste(c(target, "_projects.csv"), collapse = ""))
score <- read.csv(paste(c(target, "_score.csv"), collapse = ""))
...
write.csv(result2, paste(c(target, "_ranking.csv"), collapse = ""))
